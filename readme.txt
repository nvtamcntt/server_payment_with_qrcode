  ...
  Keystore details
  ----------------
  Filename: QRCodePayment1-sandbox
  ...
  ----------------------
  Java keytool:
  keytool -storetype PKCS12 -list -keystore QRCodePayment1-sandbox.p12 -storepass keystorepassword -v

  OpenSSL:
  openssl pkcs12 -info -in QRCodePayment1-sandbox.p12 -password pass:keystorepassword
